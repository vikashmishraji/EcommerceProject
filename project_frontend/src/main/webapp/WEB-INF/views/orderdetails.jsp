...
<div class="container-wrapper">
    <div class="container">
        <div class="page-header">
             <h1>Order</h1> 
            <marquee  behavior="scroll" direction="slo"><h3>welcome to computer market</h3></marquee>
 <marquee behavior="scroll" direction="left" scrollamount="6"><h1>welcome</h></marquee> 
 
            <p class="lead">Order confirmation</p>
        </div>

        <div class="container">
        <c:url value="/cart_confirm${cartid }" var="url"></c:url>
